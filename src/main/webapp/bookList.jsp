            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="navbar-nav ml-md-auto">
                        <li class="nav-item active"><a class="nav-link" href="javascript:void(0)"> <select id="themeSel"
                                                                                                           class="custom-select">
            ...
            <div class="card border-success">
                <div class="card-header">
                    ...
                    <form class="form-inline" action="bookList" method="post" id="searchFrm">
                        ...
                        <input type="text" class="form-control mb-2 mr-sm-2" id="inputName" placeholder="书名" name="name"
                    ...
                    <div class="col-md-12" style="padding: 0px;">
                        <table class="table  table-bordered  table-sm table-hover" style="margin-bottom: 0px;">
                            ...
                            <tr>
                                ...
                                <td style="max-width: 100px;"><%=book.getDescri()%>
                                </td>
                                <td>
                                    <a href="#modal-container-904239" data-toggle="modal"
                                       onclick="window.delId='<%=book.getId()%>'"  class="fa fa-trash fa-2x" title="删除"></a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="card-footer" style="padding: 0px;">
                    <nav>
                        <ul class="pagination" style="margin-bottom: 0px;">
                            ...
                            <li class="page-item"><a class="page-link" href="bookList?currentPage=<%=totalPage%>">...<%=totalPage%>
                            </a></li>
                            <%
                            ...
                            <li class="page-item">
                                <a class="page-link" href="bookList?currentPage=1">1...</a></li>
                            <li class="page-item">
                                <a class="page-link" href="bookList?currentPage=<%=totalPage - 3%>"><%=totalPage - 3%>
                                </a></li>
                            <li class="page-item">
                                <a class="page-link"
